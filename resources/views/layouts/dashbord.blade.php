        ...
        <nav class="navbar navbar-default navbar-fixed">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ route('index') }}"><i style="font-size: 35px;" class="pe-7s-left-arrow"></i></a>
                </div>
            ...
            <div class="container-fluid">
             <!--
                ...
                <p class="copyright text-center">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">G-Stock</a>
                </p>
            </div>
        </footer>
